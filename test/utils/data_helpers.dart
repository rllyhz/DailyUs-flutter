...
var exampleLoginResult = {
  ...
  "name": "user_example",
  "token": "token-example-1234"
};
var authSuccessJson = {
  "error": false,
  "message": "success",
  "loginResult": exampleLoginResult
};
...
var exampleStory3 = {
  ...
  "photoUrl": "url-here",
  "createdAt": "13-05-2032"
};
var getAllStoriesSuccessJson = {
  "error": false,
  "message": "success",
  "listStory": [exampleStory1, exampleStory2, exampleStory3]
};
...
var exampleUser = {
  "id": "user-1",
  "name": "username-1",
  "token": "example-token-user-1",
  "email": "example_email@mail.com"
};
var authInfoLoggedInJson = {"isAlreadyLoggedIn": true, "user": exampleUser};
var authInfoNotLoggedInJson = {"isAlreadyLoggedIn": false, "user": exampleUser};
...
const localeTest = Locale('id');

var localizationModelTest = LocalizationModel(
  languageCode: localeTest.languageCode,
);

const localization = Localization(currentLocale: localeTest);
